...
export const userProfileErrors = {
  ...
  invalidFirstName: 'Firstname should be an Alphabet with no spaces',
  undefinedLastName: 'Lastname is required',
  invalidLastName: 'Lastname should be an Alphabet with no spaces',
  undefinedEmail: 'Email is required',
  undefinedPassword: 'Password is required',
  invalidPassword: 'Password cannot be less than 8 characters',
  invalidEmail: 'Enter a valid email address',
  ...
  invalidPreferredLanguage: 'Preferred Language should be an Alphabet with no spaces',
  undefinedCurrency: 'Currency is required',
  invalidCurrency: 'Currency should be an Alphabet with no spaces',
  ...
  invalidDepartment: 'Department should be an aqlphabet with no spaces',
